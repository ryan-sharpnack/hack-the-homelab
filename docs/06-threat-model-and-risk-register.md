...
| IHA-012 | Loki/Grafana/Alloy provides centralized log aggregation but no native alerting or file integrity monitoring (FIM), unlike the originally-planned Wazuh deployment —
