...
| Audit logging & monitoring | Wazuh centralized logging, alerting, FIM | §164.312(b) Audit Controls | AU-2, AU-6 | Audit controls implementation | CIS Control 8 — Audit Log Management |
